...
VALUES
    ...
    ('REGULAR', 'HOD_APPROVED',                   'Finance Officer',         'HOD Approved',
     'Verify that sufficient funds are available for this request.',                                        30),
    ('REGULAR', 'FUNDS_VERIFIED',                 'Director HRM&A',          'Funds Verified',
     'Review and approve this procurement request.',                                                        40),
    ('REGULAR', 'DIRECTOR_APPROVED',              'Deputy Government Chemist','Director Approved',
     'Review and provide final approval for this request.',                                                 50),
    ('REGULAR', 'GC_APPROVED',                    'Procurement Officer',     'GC Approved',
     'Generate and issue the RFQ letter to shortlisted vendors.',                                           60),
    ('REGULAR', 'RFQ_LETTER_AVAILABLE',           'Procurement Officer',     'RFQ Letters',
     'Collect and record vendor quotations for this request.',                                              70),
    ('REGULAR', 'QUOTE_REVIEW_PENDING',           'Branch Head / Procurement Officer', 'Quote Review',
    ...
    ('REGULAR', 'QUOTE_APPROVED',                 'Finance Officer',         'Quote Selected',
     'Verify funds and create the financial commitment.',                                                   90),
    ...
    ('REGULAR', 'PO_PENDING',                     'Accounts Officer',        'PO Created',
     'Upload and record the vendor invoice once goods are received.',                                      120),
    ('REGULAR', 'PO_APPROVED',                    'Accounts Officer',        'PO Approved',
     'Upload and record the vendor invoice once goods are received.',                                      125),
...
VALUES
    ...
    ('SERVICE_CONTRACT', 'HOD_APPROVED',        'Finance Officer',         'Branch Approved',
     'Verify that funds are available for this service contract.',                                          30),
    ('SERVICE_CONTRACT', 'DIRECTOR_APPROVED',   'Deputy Government Chemist','Director Approved',
     'Provide final approval for this service contract.',                                                   40),
