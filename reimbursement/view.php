              ...
              <div class="card bg-light">
                <div class="card-body">
                  ...
                  <a href="/reimbursement/print_for_signing.php?request_id=<?= $request_id ?>" 
                     ...
                     data-request-type="REIMBURSEMENT"
...
(function () {
  ...
  document.querySelectorAll('.js-signed-print-btn').forEach(function (btn) {
    btn.addEventListener('click', function (event) {
      ...
      const requestType = (btn.dataset.requestType || 'REIMBURSEMENT').toUpperCase();
  ...
  document.querySelectorAll('.js-signed-upload-form').forEach(function (form) {
    form.addEventListener('submit', function (event) {
      ...
      const requestType = (form.dataset.requestType || 'REIMBURSEMENT').toUpperCase();
