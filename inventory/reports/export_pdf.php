...
<div style="padding:4px 16px 8px;font-size:9px;display:flex;gap:24px;">
<span>Total Items: <b>' . number_format(count($rows)) . '</b></span>
<span>Total Qty: <b>' . number_format($grandQty, 2) . '</b></span>
<span>Total Value: <b>$' . number_format($grandTotal, 2) . '</b></span>
</div>
